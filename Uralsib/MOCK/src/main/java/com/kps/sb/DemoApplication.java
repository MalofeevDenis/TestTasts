...
/////////////EMULATING
    ...
    @GetMapping(value = "/Service/ProductCatalogueRomashka_Service.serviceagent/ProductCatalogueEndpoint0", produces = "multipart/form-data;charset=UTF-8")
...
/*
    ...
    @GetMapping(value = "/SOAP_TIBCO/PODB", produces = "multipart/form-data;charset=UTF-8")
